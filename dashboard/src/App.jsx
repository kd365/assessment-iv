...
const SERVICES = [
  {
    ...
    namespace: 'client-a',
    url: import.meta.env.VITE_CLIENT_A_URL || 'http://localhost:8001',
    featureCount: 43,
  ...
  },
  {
    ...
    namespace: 'client-b',
    url: import.meta.env.VITE_CLIENT_B_URL || 'http://localhost:8002',
    featureCount: 12,
  ...
  },
  {
    ...
    namespace: 'client-c',
    url: import.meta.env.VITE_CLIENT_C_URL || 'http://localhost:8003',
    featureCount: null,
    testPayload: null,
  },
]
